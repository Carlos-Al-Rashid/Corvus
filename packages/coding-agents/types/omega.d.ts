 ...
 */
export type OmegaFunction = (intent: IntentSpace, world: WorldSpace) => Promise<ResultSpace>;
/**
 * Synchronous omega function (for simple transformations)
 */
export type OmegaFunctionSync = (intent: IntentSpace, world: WorldSpace) => ResultSpace;
/**
 * Omega function with streaming results
 */
export type OmegaFunctionStream = (intent: IntentSpace, world: WorldSpace) => AsyncGenerator<Partial<ResultSpace>, ResultSpace, unknown>;
/**
 ...
 */
export type OmegaComposition = (omega1: OmegaFunction, omega2: OmegaFunction) => OmegaFunction;
/**
 * Omega parallel: Ω₁ ∥ Ω₂
 *
 * Executes two omega functions in parallel and merges results
 */
export type OmegaParallel = (omega1: OmegaFunction, omega2: OmegaFunction, merger: ResultMerger) => OmegaFunction;
/**
 * Omega conditional: Ω₁ ? Ω₂ : Ω₃
 *
 * Chooses omega function based on predicate
 */
export type OmegaConditional = (predicate: (intent: IntentSpace, world: WorldSpace) => boolean, omegaTrue: OmegaFunction, omegaFalse: OmegaFunction) => OmegaFunction;
/**
 * Result merger for parallel execution
 */
export type ResultMerger = (result1: ResultSpace, result2: ResultSpace) => ResultSpace;
/**
 ...
 * Error handler
 */
export type OmegaErrorHandler = (error: Error, context: OmegaContext) => Promise<ResultSpace | null>;
/**
 * Omega pipeline
 */
export interface OmegaPipeline {
    ...
    execute: (intent: IntentSpace, world: WorldSpace) => Promise<ResultSpace>;
    /** Add a stage */
 ...
 */
export declare const DEFAULT_OMEGA_OPTIONS: OmegaExecutionOptions;
/**
 * Create a simple omega function from a handler
 */
export declare function createOmegaFunction(handler: (intent: IntentSpace, world: WorldSpace) => Promise<ResultSpace>): OmegaFunction;
/**
 * Compose two omega functions
 */
export declare function composeOmega(omega1: OmegaFunction, omega2: OmegaFunction): OmegaFunction;
