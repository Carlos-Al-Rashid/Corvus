 ...
 */
export type IntentRefiner = (intent: IntentSpace, context: Record<string, unknown>) => IntentRefinement;
/**
 * Parse natural language into intent
 */
export type IntentParser = (naturalLanguage: string, context?: Record<string, unknown>) => Promise<IntentSpace>;
