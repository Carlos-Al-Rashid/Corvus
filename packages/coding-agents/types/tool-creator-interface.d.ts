...
export interface IToolCreator {
     ...
     */
    createSimpleTool(name: string, description: string, type: 'command' | 'api' | 'library' | 'service', params?: Record<string, any>): Promise<{
        success: boolean;
        tool?: any;
        error?: string;
        durationMs: number;
     ...
     */
    createToolFromDescription(description: string, context: {
     ...
     */
    createAndExecuteTool(requirement: ToolRequirement, params: any, context: {
        agentInstanceId: string;
        taskId: string;
        timestamp: string;
    }): Promise<{
     ...
     */
    executeTool(tool: any, params: any, context: {
        agentInstanceId: string;
        taskId: string;
        timestamp: string;
    }): Promise<{
...
//# sourceMappingURL=tool-creator-interface.d.ts.map