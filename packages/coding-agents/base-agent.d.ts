 ...
 * - Logging
 */
import { AgentType, AgentResult, EscalationTarget, Severity, Task, AgentConfig, ToolInvocation, IssueState } from './types/index';
import { AgentMessage, MessageResponse, MessageType, MessagePriority } from './types/communication';
...
export declare abstract class BaseAgent {
     ...
     */
    setTraceLogger(logger: IssueTraceLogger): void;
    /**
     ...
     */
    protected sendMessage<T = unknown>(to: AgentType, type: MessageType, payload: T, priority?: MessagePriority): Promise<MessageResponse>;
    /**
     ...
     * @returns Promise<MessageResponse>
     */
    protected receiveMessage(message: AgentMessage): Promise<MessageResponse>;
    /**
