 ...
 */
function detectProjectType(config) {
    if (!config)
        return 'typescript';
 ...
 */
function inferArchitecturePatterns(config) {
...
//# sourceMappingURL=context-to-world.js.map