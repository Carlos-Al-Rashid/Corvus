...
(function (SecurityIssueType) {
    SecurityIssueType["EVAL_USAGE"] = "eval_usage";
    SecurityIssueType["EXEC_USAGE"] = "exec_usage";
    SecurityIssueType["REQUIRE_DYNAMIC"] = "require_dynamic";
    SecurityIssueType["CHILD_PROCESS"] = "child_process";
    SecurityIssueType["FILE_SYSTEM_WRITE"] = "file_system_write";
    SecurityIssueType["NETWORK_REQUEST"] = "network_request";
    SecurityIssueType["ENVIRONMENT_ACCESS"] = "environment_access";
    SecurityIssueType["GLOBAL_MODIFICATION"] = "global_modification";
    SecurityIssueType["PROTOTYPE_POLLUTION"] = "prototype_pollution";
    SecurityIssueType["ARBITRARY_CODE"] = "arbitrary_code";
...
export class SecurityValidator {
     ...
     */
    static getCodeSnippet(code, index, contextLines = 2) {
